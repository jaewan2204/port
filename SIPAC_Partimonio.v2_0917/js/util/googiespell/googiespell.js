...
function GoogieSpell(img_dir, server_url) {
    ...
    this.lang_chck_spell = "Verificar Ortografía";
    this.lang_revert = "Revertir";
    this.lang_close = "Cerrar";
    this.lang_rsm_edt = "Editar";
    this.lang_no_error_found = "No se encontraron errores.";
    this.lang_no_suggestions = "No hay sugerencias.";
