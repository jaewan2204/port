$(function() {
    ...
    var etn = 0;
    var ind = 0;
    $('[name=totalCnt]').each(function(i, v) {
        if ($(v).data('classCd') == '00500001') {
            pal += $(v).data('totalCnt');
        }
        if ($(v).data('classCd') == '00500002') {
            pre += $(v).data('totalCnt');
        }
        if ($(v).data('classCd') == '00500003' || $(v).data('classCd') == '00500006' || $(v).data('classCd') == '00500007') {
            his += $(v).data('totalCnt');
        }
        if ($(v).data('classCd') == '00500004' || $(v).data('classCd') == '00500008' || $(v).data('classCd') == '00500010') {
            etn += $(v).data('totalCnt');
        }
        if ($(v).data('classCd') == '00500005' || $(v).data('classCd') == '00500009' || $(v).data('classCd') == '00500011') {
            ind += $(v).data('totalCnt');
        }
    });
    arr.push({
        totalCnt: pal,
        labelText: 'Paleontológico'
    });
    arr.push({
        totalCnt: pre,
        labelText: 'Prehispánico'
    });
    arr.push({
        totalCnt: his,
        labelText: 'Histórico-artístico'
    });
    arr.push({
        totalCnt: etn,
        labelText: 'Etnográfico'
    });
    arr.push({
        totalCnt: ind,
    ...
    $('.searchBtn').on('click', function() {
        $('#SRCH_FORM').attr('action', '/pm/pmEstadistica/clasification.do');
    ...
    $('.excelDownload').on('click', function() {
        ...
        $('#strCols').val(strCols);
        $('#SRCH_FORM').attr('action', '/pm/pmEstadistica/clasificationExcelList.do');
        $('#SRCH_FORM').submit();
    });
