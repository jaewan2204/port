    ...
    $.extend($, {
        DEFAULT_SETTINGS: {
            ...
            navImages: {
                zoomIn: {
                    ...
                    GROUP: "zoomin_rest.svg",
                    HOVER: "zoomin_hover.svg",
                    DOWN: "zoomin_hover.svg"
                },
                zoomOut: {
                    REST: "zoomout_rest.svg",
                    GROUP: "zoomout_rest.svg",
                    HOVER: "zoomout_hover.svg",
                    DOWN: "zoomout_hover.svg"
                },
                home: {
                    REST: "home_rest.svg",
                    GROUP: "home_rest.svg",
                ...
                fullpage: {
                    ...
                    GROUP: "fullpage_rest.svg",
                    HOVER: "fullpage_hover.svg",
                    DOWN: "fullpage_hover.svg"
                },
                rotateleft: {
                    REST: "rotateleft_rest.svg",
                    GROUP: "rotateleft_rest.svg",
                    HOVER: "rotateleft_hover.svg",
                    DOWN: "rotateleft_hover.svg"
                },
                rotateright: {
                    REST: "rotateright_rest.svg",
                    GROUP: "rotateright_rest.svg",
                    HOVER: "rotateright_hover.svg",
                    DOWN: "rotateright_hover.svg"
                },
                flip: {
                    REST: "flip_rest.svg",
                    GROUP: "flip_rest.svg",
                ...
                previous: {
                    ...
                    GROUP: "previous_rest.svg",
                    HOVER: "previous_hover.svg",
                    DOWN: "previous_hover.svg"
                },
                next: {
                    REST: "next_rest.svg",
                    GROUP: "next_rest.svg",
        ...
        makeAjaxRequest: function (e, t, i) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState) {
                    a.onreadystatechange = function () {};
                    if (a.status >= 200 && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s) t(a);
                    else {
            ...
            function s() {
                ...
                for (; i._loadQueue.length && (t = i._loadQueue[0]).tileSource;) {
                    ...
                    if (t.options.replace) {
                        var s = i.world.getIndexOfItem(t.options.replaceItem); - 1 != s && (t.options.index = s);
...
! function (e) {
    ...
    e.extend(e.DziTileSource.prototype, e.TileSource.prototype, {
        ...
        configure: function (i, n) {
            ...
            if (n && !o.tilesUrl) {
                o.tilesUrl = n.replace(/([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/, "$1_files/"); - 1 != n.search(/\.(dzi|xml|js)\?/) ? o.queryParams = n.match(/\?.*/) : o.queryParams = ""
            }
            return o
        },
        getTileUrl: function (e, t, i) {
...
! function (e) {
    ...
    e.extend(e.IIIFTileSource.prototype, e.TileSource.prototype, {
        ...
        getTileUrl: function (e, t, i) {
            ...
            var o, r, s, a, l, h, c, u, d, p, g, m = Math.pow(.5, this.maxLevel - e),
...
! function (e) {
    ...
    e.extend(e.ReferenceStrip.prototype, e.EventSource.prototype, e.Viewer.prototype, {
        setFocus: function (t) {
            var i, n = e.getElement(this.element.id + "-" + t),
    ...
    function o(t, i, n) {
        ...
        r = Math.ceil(i / o) + 5;
        for (h = r = (r = (s = Math.ceil((Math.abs(n) + i) / o) + 1) - r) < 0 ? 0 : r; h < s && h < t.panels.length; h++)
...
! function (e) {
    ...
    e.Tile.prototype = {
        ...
        drawCanvas: function (t, i, n, o) {
            var r, s = this.position.times(e.pixelDensityRatio),
        ...
        if (void 0 === i || void 0 === n) {
            ...
            for (s in o)
                if (o.hasOwnProperty(s)) {
                    r = o[s];
                    for (a in r)
                        if (r.hasOwnProperty(a) && !r[a]) return !1
                } return !0
        }
